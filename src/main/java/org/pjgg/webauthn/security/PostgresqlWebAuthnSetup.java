package org.pjgg.webauthn.security;
...
import org.pjgg.webauthn.model.User;
import org.pjgg.webauthn.model.WebAuthnCertificate;
import org.pjgg.webauthn.model.WebAuthnCredential;

@ApplicationScoped
public class PostgresqlWebAuthnSetup implements WebAuthnUserProvider {
    ...
    public Uni<List<Authenticator>> findWebAuthnCredentialsByUserName(String userName) {
        return WebAuthnCredential.findByUserName(userName)
                .flatMap(PostgresqlWebAuthnSetup::toAuthenticators);
    }
